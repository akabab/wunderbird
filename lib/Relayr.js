...
var device_id = {
    light: "ea3dba60-09c5-47a9-b52d-9ac6160565e1",
    temp: "562ed140-19df-410e-972b-8ad8b07eec31",
    sound: "9e3ca624-ce2b-43bf-a2cd-db7d62a780b1",
    accel: "7543f039-d69d-4944-b8cf-7301791c6ec7"
};
...
relayr.connect(token, device_id.light);
relayr.connect(token, device_id.temp);
// relayr.connect(token, device_id.sound);
// relayr.connect(token, device_id.accel);
